...
const modules = [
  ...
  { id: 'estoque_detalhado', label: 'Visão Detalhada de Estoque', keywords: 'estoque detalhe cobertura giro', icon: Boxes, permission: 'stock' },
  { id: 'alertas_inteligentes', label: 'Central de Alertas', keywords: 'alertas inteligência riscos ruptura queda', icon: BarChart3, permission: 'stock' },
  { id: 'comparativo', label: 'Vendas Anuais', keywords: 'comparativo anual vendas', icon: BarChart3, permission: 'sales' },
  { id: 'price_table', label: 'Tabelas de Preço', keywords: 'preço tabela', icon: FileText, permission: 'sales' },
