...
var require_index_browser = __commonJS({
  "node_modules/@prisma/client/runtime/index-browser.js"(exports, module) {
    ...
    var Ge = (e, n, i, r) => {
      if (n && typeof n == "object" || typeof n == "function") for (let t of We(n)) !je.call(e, t) && t !== i && he(e, t, { get: () => n[t], enumerable: !(r = Je(n, t)) || r.enumerable });
      return e;
    };
    ...
    d.hyperbolicSine = d.sinh = function() {
      ...
      if (n = s.precision, i = s.rounding, s.precision = n + Math.max(t.e, t.sd()) + 4, s.rounding = 1, r = t.d.length, r < 3) t = J(s, 2, t, t, true);
      else {
    ...
    d.inverseTangent = d.atan = function() {
      ...
      if (f.isFinite()) {
        ...
        if (f.abs().eq(1) && a + 4 <= ve) return o = R(c, a + 4, h).times(0.25), o.s = f.s, o;
      } else {
      ...
      for (w = false, n = Math.ceil(u / m), r = 1, l = f.times(f), o = new c(f), t = f; e !== -1; ) if (t = t.times(l), s = o.minus(t.div(r += 2)), t = t.times(l), o = s.plus(t.div(r += 2)), o.d[n] !== void 0) for (e = n; o.d[e] === s.d[e] && e--; ) ;
    ...
    d.logarithm = d.log = function(e) {
      ...
      if (w = false, u = a + g, o = B(f, u), r = n ? se(c, u + 10) : B(e, u), l = S(o, r, u, 1), Q(l.d, t = a, h)) do
    ...
    d.squareRoot = d.sqrt = function() {
      ...
      for (w = false, f = Math.sqrt(+o), f == 0 || f == 1 / 0 ? (n = O(u), (n.length + l) % 2 == 0 && (n += "0"), f = Math.sqrt(n), l = A((l + 1) / 2) - (l < 0 || l % 2), f == 1 / 0 ? n = "5e" + l : (n = f.toExponential(), n = n.slice(0, n.indexOf("e") + 1) + l), r = new c(n)) : r = new c(f.toString()), i = (l = c.precision) + 3; ; ) if (s = r, r = s.plus(S(o, s, i + 2, 1)).times(0.5), O(s.d).slice(0, i) === (n = O(r.d)).slice(0, i)) if (n = n.slice(i - 3, i + 1), n == "9999" || !t && n == "4999") {
    ...
    d.toFraction = function(e) {
      ...
      for (w = false, u = new N(O(v)), c = N.precision, N.precision = s = v.length * m * 2; a = S(u, n, 0, 1, 1), t = i.plus(a.times(r)), t.cmp(e) != 1; ) i = r, r = t, t = f, f = l.plus(a.times(t)), l = t, t = n, n = u.minus(a.times(t)), u = t;
    ...
    var S = /* @__PURE__ */ function() {
      ...
      return function(r, t, s, o, u, l) {
        ...
        if (k[a] > (b[a] || 0) && c--, s == null ? (D = s = ee.precision, o = ee.rounding) : u ? D = s + (r.e - t.e) + 1 : D = s, D < 0) T.push(1), v = true;
        else {
    ...
    function se(e, n, i) {
      if (n > ye) throw w = true, i && (e.precision = i), Error(Te);
    ...
    function Ee(e, n) {
      ...
      for (n == null ? (w = false, l = v) : l = n, u = new h(0.03125); e.e > -2; ) e = e.times(u), a += 5;
      for (r = Math.log(M(2, a)) / Math.LN10 * 2 + 5 | 0, l += r, i = s = o = new h(1), h.precision = l; ; ) {
        if (s = p(s.times(e), l, 1), i = i.times(++c), u = o.plus(S(s, i, l, 1)), O(u.d).slice(0, l) === O(o.d).slice(0, l)) {
          ...
          else return p(o, h.precision = v, g, w = true);
    ...
    function B(e, n) {
      ...
      } else return f = se(C, c + 2, E).times(s + ""), N = B(new C(r + "." + i.slice(1)), c - v).plus(f), C.precision = E, n == null ? p(N, E, T, w = true) : N;
      for (a = N, l = o = N = S(N.minus(1), N.plus(1), c, 1), h = p(N.times(N), c, 1), t = 3; ; ) {
        ...
        else return p(l, C.precision = E, T, w = true);
    ...
    function mn(e) {
      ...
      if (i = "crypto", t && (this[i] = Ne[i]), (r = e[i]) !== void 0) if (r === true || r === false || r === 0 || r === 1) if (r) if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) this[i] = true;
      else throw Error(Le);
      else this[i] = false;
      else throw Error($ + i + ": " + r);
      return this;
